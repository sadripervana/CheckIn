...
if($case != 'addguest')
  ...
  <form action="" method="post">
   ...
   <input class="ui-btn ui-btn-icon-bottom"
   type="submit" data-icon="search"  name="submit-search"></button>
  </form>
_SEARCH;
...
if($case == 'home' ):
    echo "<h1> Guest List</h1>";
elseif($case =='checkedin'):
  echo "  <h1> Checkedin List</h1>";
else: echo "<h1>Add Guest</h1>";
 endif;
